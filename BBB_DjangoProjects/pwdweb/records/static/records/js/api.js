/**
 * Created by frank on 21-Dec-16.
 */
var baseURL = 'http://127.0.0.1:55555/password';
    ...
    $.ajax({
        ...
        success: function(data, status, request) {
            ...
            if(valid) {
                ...
                infoClass = (score<10?'Poor':(score<18?'orange':'green'));
                msg += ' (Score: {score}, {grade})'.replace('{score}', score).replace('{grade}', grade);
            }
            $('#pwd-info').html(msg);
